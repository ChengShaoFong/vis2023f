...
function _simple1(d3,simple,drag,url_list,invalidation)
{
  ...
  // 添加節點外框
  const circleRadius = 35; // 調整圓圈半徑大小
  node.append("circle")
      .attr("r", circleRadius)
  ...
  const imageRadius = circleRadius + 20; // 圖片環繞外框的半徑
  const imageWidth = 35; // 圖片的寬度
  const imageHeight = 35; // 圖片的高度
...
FileAttachment("teamgroup.json").json()
)}
...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
    ["teamgroup.json", {url: new URL("./files/66429cfa62b7fce0f14ff37b3df516001b4a89439f10dc2c1e98dbf9e62c89bcf5dcde723191510c52c988a01cf5c96049a1c16fda0a066833fd3e40cf8a2525.json", import.meta.url), mimeType: "application/json", toString}]
  ]);
