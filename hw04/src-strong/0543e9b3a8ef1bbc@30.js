...
function _chart(d3,data)
{
  ...
  // 需要據此調整顏色比例尺的domain
  const color = d3.scaleOrdinal(d3.schemeSet3).domain(data.map(d => d[1]));
  ...
  const svg = d3.create("svg")
      ...
      .attr("width", width)
      .attr("height", height)
      .attr("style", "max-width: 90%; height: auto; font: 13px sans-serif;");
...
<h3>從上圖中，我們可以看出：
  <ul>
    ...
    <li>基於我觀察與了解，藝術產業的碳排放量大致位於3級，介於中等。</li>
    <li>人員商務差旅可能排放量較多，因其包含長途交通與資源消耗。</li>
    <li>管藝術活動的製作和展示可能產生排放，但相對於某些其他行業，它可能屬於中等或較低排放水平。</li>
  </ul>
</h3>`
)}
